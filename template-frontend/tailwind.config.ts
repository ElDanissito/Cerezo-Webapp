...
const config: Config = {  content: [
  ...
  theme: {
    fontFamily: {
      "euclid-circular-a": ["Euclid Circular A"] // 👈 esto habilita "font-outfit"
    },
    container: {
      center: true,
      padding: {
    ...
    colors: {
      ...
      300: "#9cb9ff",
      400: "#7592ff",
      500: "#465fff",  // 👈 text-brand-500, bg-brand-500, etc.
      600: "#3641f5",
      700: "#2a31d8",
      800: "#252dae",
      900: "#262e89",
    ...
    extend: {
      colors:{
        "brand-500-15": "rgba(70, 95, 255, 0.15)",
    ...
    error: {
      ...
      boxShadow: {
        ...
        "theme-xl": "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)", // ejemplo, shadow-xl de Tailwind
        datepicker: "0px 4px 20px rgba(0, 0, 0, 0.25)", // 👈 aquí inventa el valor
      "slider-navigation": "0 2px 8px rgba(0, 0, 0, 0.15)", 
      "theme-xs": "0 1px 2px rgba(0, 0, 0, 0.08)",
      },
    },
  },
  plugins: [],
