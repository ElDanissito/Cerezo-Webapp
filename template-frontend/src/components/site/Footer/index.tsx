        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
             {/* Ubicación */}
              <li className="flex items-center gap-3 font-medium text-gray-800 hover:text-red-600 transition-colors duration-200">
                <span className="p-1 border-2 border-red-500 rounded-full flex items-center justify-center">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
                ...
                <a
                  href="https://www.google.com/maps/place/Rapitienda+El+Cerezo/@3.4708967,-76.4989713,20.63z/data=!4m14!1m7!3m6!1s0x8e30a7cd83ca28fd:0xd875e1e8463d39cc!2sCl.+56+%231d-2+42,+Comuna+5,+Cali,+Valle+del+Cauca!3b1!8m2!3d3.4726563!4d-76.4995635!3m5!1s0x8e30a7cdbaeb6e2f:0xf37721ed011c43c1!8m2!3d3.4709532!4d-76.4988117!16s%2Fg%2F11b7q6522g?entry=ttu"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Calle 56 1D2-42, Barrio Los Andes
                </a>
              </li>
              ...
              <li className="flex items-center gap-3 font-medium text-gray-800 hover:text-red-600 transition-colors duration-200">
                <span className="p-1 border-2 border-red-500 rounded-full flex items-center justify-center">
                  ...
                  >
                    <path
                      fill="#25D366"
                      d="M16 .667C7.64.667.667 7.64.667 16c0 2.818.74 5.437 2.036 7.71L.667 31.333l7.77-2.036A15.267 15.267 0 0 0 16 31.333c8.36 0 15.333-6.973 15.333-15.333S24.36.667 16 .667z"
                    />
                    <path
                      fill="#fff"
                      d="M24.267 21.467c-.34.96-1.96 1.84-2.74 1.94-.7.08-1.54.12-2.48-.16-.57-.18-1.3-.42-2.25-.82-3.96-1.72-6.54-5.74-6.74-6-.2-.26-1.6-2.12-1.6-4.04 0-1.92 1-2.88 1.36-3.28.36-.4.8-.5 1.06-.5.26 0 .53 0 .76.01.24.01.57-.09.9.68.34.8 1.15 2.77 1.25 2.96.1.2.17.43.03.7-.14.28-.22.43-.44.66-.2.22-.45.5-.64.67-.21.17-.43.36-.18.72.26.36 1.15 1.9 2.48 3.07 1.7 1.52 3.13 2 3.53 2.23.4.22.63.18.86-.1.23-.28 1-1.16 1.27-1.56.27-.4.53-.33.9-.2.37.14 2.35 1.11 2.75 1.31.4.2.67.3.77.46.1.16.1.94-.24 1.9z"
                    />
                  </svg>
                </span>
                <a href="https://wa.me/573206767334?text=Hola%20quiero%20más%20información%20sobre%20sus%20servicios%20de%20copiado" target="_blank" rel="noopener noreferrer">
                  (+57) 320 676 7334
                </a>
              </li>
              ...
              <li className="flex items-center gap-3 font-medium text-gray-800 hover:text-red-600 transition-colors duration-200">
                <span className="p-1 border-2 border-red-500 rounded-full flex items-center justify-center">
                  ...
                  >
                    <path
                      fill="#e0e0e0"
                      d="M45,16.2l-4.9,3.7V36h3c1.1,0,2-0.9,2-2V16.2z"
                    />
                    <path
                      fill="#e0e0e0"
                      d="M3,16.2l4.9,3.7V36h-3c-1.1,0-2-0.9-2-2V16.2z"
                    />
                    <path
                      fill="#d93025"
                      d="M24,27L3,11.6V16l21,15l21-15v-4.4L24,27z"
                    />
                    <path
                      fill="#fbbc04"
                      d="M3,12c0-1.1,0.9-2,2-2h3l16,12l16-12h3c1.1,0,2,0.9,2,2v4L24,28L3,16V12z"
                    />
                    <path
                      fill="#34a853"
                      d="M3,36c0,1.1,0.9,2,2,2h3V19.9l-5-3.6V36z"
                    />
                    <path
                      fill="#4285f4"
                      d="M45,36c0,1.1-0.9,2-2,2h-3V19.9l5-3.6V36z"
                    />
                  </svg>
                </span>
                <a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=soporte.elcerezo@gmail.com&su=Consulta%20sobre%20servicios%20de%20copiado&body=Hola%2C%20quisiera%20más%20información%20sobre%20sus%20servicios%20de%20copiado.%20Gracias."
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  soporte.elcerezo@gmail.com
                </a>
              </li>
