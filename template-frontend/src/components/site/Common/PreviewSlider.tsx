...
const PreviewSliderModal = () => {
  ...
  // Si estás usando estos datos, puedes mapearlos abajo.
  ...
  return (
    ...
    >
      ...
      <Swiper ref={sliderRef} slidesPerView={1} spaceBetween={20}>
        {/* Ejemplo: si usas "data" del store, podrías mapear aquí */}
        {/* {data.images?.map((src: string) => (
          <SwiperSlide key={src}>
            <div className="flex justify-center items-center">
              <Image src={src} alt="product image" width={450} height={450} />
            </div>
          </SwiperSlide>
        ))} */}
